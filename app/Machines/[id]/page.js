  ...
  return (
    <div>
      <div className="flex justify-center my-4">
        ...
        >
          <label htmlFor="slot" className="ml-[80px] text-white font-bold">
            Slot Number
          </label>
          <input
            type="number"
          ...
          <label
            ...
            className="ml-[80px] text-white font-bold"
          >
            Medicine Name
          </label>
          <input
          ...
          />
          {/* <label htmlFor="dosage" className="ml-[80px] text-white font-bold">
            Dosage(mg)
          </label>
          <input
            type="number"
          ...
          /> */}
          <label
            htmlFor="capsuleeachpack"
            className="ml-[80px] mt-2 text-white font-bold"
          >
            Capsules in one pack
          </label>
          <input
            type="number"
            min={1}
      ...
      <h1 className="text-blue-500 text-lg font-bold text-center">
        Medicine Detials
      </h1>
      <hr className="border-blue-500" />
      {medicinedetails.length ? null : (
        <div className=" text-blue-400 font-bold px-2">
          No Medicine Available in machine
        </div>
      )}
      {medicinedetails.map((medicine) => (
        <div
          key={medicine.slot}
          className="flex justify-evenly flex-wrap bg-white m-2"
        >
          ...
          <p className="whitespace-nowrap mx-2">
            Sold and not collected: {medicine.soldandnotcollected}
          </p>
        </div>
      ))}
    </div>
